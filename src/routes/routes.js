...
router.get('/logout',checkAuthenticated ,(req,res) => userController.logout(req,res));
...
//Messaging routes
router.get('/chat/:roomId',checkAuthenticated, async (req,res) =>   res.render('messagerie',{ idRoom: req.params.roomId , user : await req.user }) );
